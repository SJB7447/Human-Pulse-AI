        ...
        >
          <section className="rounded-[36px] bg-white/74 px-6 py-8 shadow-[0_24px_60px_rgba(35,34,33,0.08)] ring-1 ring-white/70 backdrop-blur-[6px] sm:px-8 md:px-10 md:py-10">
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        boxShadow: isActive
                          ? `0 12px 26px ${hexToRgba(emotion.chipColor, 0.16)}`
                          : '0 10px 24px rgba(35,34,33,0.05)',
                        border: `1px solid ${hexToRgba(emotion.chipColor, isActive ? 0.42 : 0.28)}`,
                      }}
            ...
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mb-8">
                <div className="mx-auto flex max-w-4xl flex-wrap justify-center gap-2 pb-2">
                  {isTopicsLoading ? (
